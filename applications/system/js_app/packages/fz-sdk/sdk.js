...
async function build(config) {
    await esbuild.build({
        ...
        alias: {
            ...
            "node:assert": path.join(__dirname, "shims/assert.js"),
            "events": path.join(__dirname, "shims/events.js"),
            "node:events": path.join(__dirname, "shims/events.js"),
            ...
            "os": path.join(__dirname, "shims/os.js"),
            "node:os": path.join(__dirname, "shims/os.js"),
            "url": path.join(__dirname, "shims/url.js"),
            "node:url": path.join(__dirname, "shims/url.js"),
            "util": path.join(__dirname, "shims/util.js"),
            "node:util": path.join(__dirname, "shims/util.js"),
            "string_decoder": path.join(__dirname, "shims/string_decoder.js"),
            "node:string_decoder": path.join(__dirname, "shims/string_decoder.js"),
            "buffer": path.join(__dirname, "shims/buffer.js"),
            "node:buffer": path.join(__dirname, "shims/buffer.js"),
            "timers": path.join(__dirname, "shims/timers.js"),
            "node:timers": path.join(__dirname, "shims/timers.js"),
            "process": path.join(__dirname, "shims/process.js"),
            "node:process": path.join(__dirname, "shims/process.js"),
            "stream": path.join(__dirname, "shims/stream.js"),
            "node:stream": path.join(__dirname, "shims/stream.js"),
            "querystring": path.join(__dirname, "shims/querystring.js"),
            "node:querystring": path.join(__dirname, "shims/querystring.js"),
            "promise": path.join(__dirname, "shims/promise.js"),
            "node:promise": path.join(__dirname, "shims/promise.js"),
            "http": path.join(__dirname, "shims/http.js"),
            "node:http": path.join(__dirname, "shims/http.js"),
            "https": path.join(__dirname, "shims/http.js"),
            "node:https": path.join(__dirname, "shims/http.js"),
            "net": path.join(__dirname, "shims/net.js"),
            "node:net": path.join(__dirname, "shims/net.js"),
            "tls": path.join(__dirname, "shims/tls.js"),
            "node:tls": path.join(__dirname, "shims/tls.js"),
        },
        supported: {
            "array-spread": false,
            "arrow": false,
